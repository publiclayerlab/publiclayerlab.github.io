---
title: "Repair is part of public system design"
date: 2026-06-03
lastmod: 2026-06-03
draft: false
weight: 50
description: "Public systems need realistic ways to detect, explain, correct, or recover from failures, not only procedures for normal operation."
tags:
...
A [complaint route]({{< relref "what-makes-a-system-contestable.md" >}}) can help reveal where repair is needed, but complaint handling is not the same as repair. A system can record dissatisfaction and still leave the problem untouched. A repair route has to reach the part of the system that can explain, correct, or escalate the problem.
...
- Steven J. Jackson, [“Rethinking Repair”](https://doi.org/10.7551/mitpress/9780262525374.003.0011) — a core source for understanding breakdown, maintenance and repair as central rather than marginal features of technological life.
- GOV.UK Service Manual, [Service Standard](https://www.gov.uk/service-manual/service-standard) — a practical public-service source on operating, improving and iterating services.
- Parliamentary and Health Service Ombudsman, [Principles of Good Administration: Putting things right](https://www.ombudsman.org.uk/about-us/our-principles/principles-good-administration/putting-things-right) — useful for grounding repair in acknowledgement, explanation, correction, remedy, and improvement when public administration goes wrong.

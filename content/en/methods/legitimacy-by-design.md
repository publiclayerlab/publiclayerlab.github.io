...
- who or what a system recognises;
- how people, organisations, claims, documents, or statuses become legible;
- how access is organised in practice;
- what users or affected publics need to understand;
- where responsibility is located;
- how errors, exclusions, or mismatches can be corrected;
- whether participation creates meaningful agency or only procedural visibility;
- whether burdens are fairly distributed or shifted onto citizens, organisations, communities, or affected publics;
- whether public claims are supported by the system’s actual design, documentation, governance, and fallback arrangements.
...
- examining whether a proposed system structurally supports its public claims;
- identifying gaps between public values and system design;
- structuring questions for further legal, policy, technical, accessibility, or governance review;
- informing procurement, design, review, accountability, or public-explanation conversations;
- preparing examples, notes, or Lab materials that make public-system and social-sector system questions easier to see.

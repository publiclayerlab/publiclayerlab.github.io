---
title: "What makes a system contestable?"
date: 2026-06-03
lastmod: 2026-06-03
draft: true
weight: 40
description: "A system is contestable when people can understand what happened and reach a route with the authority and capability to address the specific problem."
tags:
...
This is why a complaint button, contact form, or general feedback route is not the same as contestability. A route can exist and still miss the part of the system where the problem was produced. That is one reason [repair]({{< relref "repair-is-part-of-public-system-design.md" >}}) has to be designed as part of the system, not left to improvisation. A help desk may be visible but have no authority to change the record. A portal may show a decision but not the reason. A form may collect feedback without reaching anyone who can review the outcome.
...
1. understand the basis of the outcome;
2. identify the body or route with authority and capability to address the specific problem;
3. provide missing or corrected information;
4. ask for review, correction, or reconsideration;
5. reach someone with authority to explain, correct, reroute, or change the outcome where that is justified.
...
- Philip Pettit, [_Republicanism: A Theory of Freedom and Government_](https://philpapers.org/rec/PETRAT) — a political-theory anchor for understanding contestability as part of protection against arbitrary or unanswerable power.
- Jennifer Cobbe, Michelle Seng Ah Lee and Jatinder Singh, [“Reviewable Automated Decision-Making: A Framework for Accountable Algorithmic Systems”](https://arxiv.org/abs/2102.04201) — a useful source on reviewability beyond model-level explanation.
- ICO and The Alan Turing Institute, [Explaining decisions made with AI](https://ico.org.uk/for-organisations/uk-gdpr-guidance-and-resources/artificial-intelligence/explaining-decisions-made-with-artificial-intelligence/) — practical guidance on explaining AI-assisted decisions to affected people.

## Policy anchor

- Regulation (EU) 2016/679, the [GDPR](https://eur-lex.europa.eu/eli/reg/2016/679/oj), and Regulation (EU) 2024/1689, the [AI Act](https://eur-lex.europa.eu/eli/reg/2024/1689/oj), include rights and duties relevant to automated decision-making, complaint routes, information and explanation in specific contexts. This note uses them as policy anchors, not as a universal legal test for all systems.
- The [European Convention on Human Rights, Article 13](https://www.echr.coe.int/documents/d/echr/convention_ENG), concerns the right to an effective remedy before a national authority for violations of Convention rights. It is included as a narrow legal touchpoint, not as a claim that every contestability problem is an Article 13 issue.
